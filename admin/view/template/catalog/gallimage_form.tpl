          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                <td class="text-left hidden" style="min-width:120px;"><?php foreach ($languages as $language) { ?>
                ...
                <td class="text-left" style="width: 30%;min-width:80px;"><textarea rows="5" name="gallimage_image[<?php echo $image_row; ?>][link]" placeholder="URL" class="form-control"><?php echo $gallimage_image['link']; ?></textarea></td>
                <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $gallimage_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="gallimage_image[<?php echo $image_row; ?>][image]" value="<?php echo $gallimage_image['image']; ?>" id="input-image<?php echo $image_row; ?>" />
                </td>
  ...
  <script type="text/javascript">
      ...
      $('input[name=\'category\']').autocomplete({
        'source': function(request, response) {
          $.ajax({
            url: 'index.php?route=catalog/category/autocomplete2&token=<?= $token; ?>&filter_name=' +  encodeURIComponent(request),
            dataType: 'json',
...
function addImage() {
    ...
    html += '  <td class="text-left hidden">';
	<?php foreach ($languages as $language) { ?>
