...
class ControllerGalleryGallery extends Controller {
	public function index() {
        ...
        $this->document->addScript('catalog/view/javascript/jquery/gallery-album/jquery.matchHeight-min.js');
		...
		if ($gallimage_info) {
            ...
            if ($gallimage_info['thumbstyle'] == 'style1') {
                $data['boxstyle'] = 'boxstyle1';
            } else if ($gallimage_info['thumbstyle'] == 'style2') {
                $data['boxstyle'] = 'boxstyle2';
            } else if ($gallimage_info['thumbstyle'] == 'style3') {
