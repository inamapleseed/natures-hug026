...
<?php } ?>
    ...
    <?php } ?>
    <div class="form-group quanity text-center">
      ...
      <?php if(!$enquiry){ ?>
        <?php if(!$not_avail) { ?>
        <button type="button" id="button-cart" data-loading-text="<?= $text_loading; ?>" class="btn yellow-butt btn-primary"><?= $button_cart; ?></button>
        <?php } ?>
      <?php }else{ ?>
